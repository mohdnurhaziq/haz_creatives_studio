    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <h2>We're <span>Haz Creatives Studio,</span> a Team of Professional Photographer from Kuching, Sarawak</h2>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="gallery-item h-100">
                        ...
                        <div class="gallery-links d-flex align-items-center justify-content-center">
                            <a href="{{ asset('assets/img/gallery/gallery-' . $i . '.jpg') }}" title="Gallery {{ $i }}" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
