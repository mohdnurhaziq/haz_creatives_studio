...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-gray-800">Edit Purchase</h1>
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-header bg-white">
            <i class="fas fa-edit me-1 text-gray-600"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                                id="unit_price" name="unit_price" value="{{ old('unit_price', $purchase->unit_price) }}" step="0.01" min="0" required>
                        </div>

                        <div class="form-group mb-3">
                            <label for="total_price" class="form-label text-gray-700">Total Price</label>
                            <input type="number" class="form-control border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                                id="total_price" name="total_price" value="{{ old('total_price', $purchase->total_price) }}" step="0.01" min="0" required readonly>
                        </div>
